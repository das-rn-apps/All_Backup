...
import { Alert, StyleSheet, View, Pressable, Text, TouchableOpacity, StatusBar, TextInput, ScrollView, KeyboardAvoidingView, Platform } from 'react-native'
...
export default function Auth() {
    ...
    async function signInWithEmail() {
        ...
        if (error) { Alert.alert(error.message) }
            ...
            // if (data) router.push("./Receipent");
            if (data) router.push("./PersonalChatBox");
            // if (data) router.push("./SpecificUser");
        }
        setLoading(false)
    }
