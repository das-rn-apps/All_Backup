...
import DateTimePickerCode from '../components/DateTimePickerCode';
...
export default function Test() {
    ...
    const onChange = (event, selectedDate) => {
        ...
        const fDate = tempDate.getDate() + "/" + tempDate.getMonth() + "/" + tempDate.getFullYear();
    ...
    return (
        <View style={{ alignItems: "center", gap: 20 }}>
            ...
            <View
                style={{ backgroundColor: "white", padding: 20, borderRadius: 10, width: 330 }}
            >
                <Picker items={customData1} />
                <Picker items={customData2} />
